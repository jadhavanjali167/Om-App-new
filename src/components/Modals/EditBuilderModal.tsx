...
export function EditBuilderModal({ isOpen, onClose, builder }: EditBuilderModalProps) {
  const { updateBuilder, loading } = useBuilders();
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              {/* Builder ID (Read-only) */}
              <div className="p-3 bg-gray-50 rounded-lg">
                <p className="text-sm text-gray-600">Builder ID: <span className="font-medium">{builder.id}</span></p>
                <p className="text-sm text-gray-600">Documents: <span className="font-medium">{builder.documents.length}</span></p>
              </div>
